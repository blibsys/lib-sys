...
<div id="content">
  ...
  <div class="item edit">
    ...
    <form class="admin-form1" action="<?php echo url_for('/admin/items/edit.php?id=' . h(u($id))); ?>" method="post">
    ...
    <dl>
      ...
      <dl>
        <dt>Title</dt>
        <dd><input type="text" name="title" class="wide-input" value="<?php echo h($item['title']); ?>" /></dd>
      </dl>
      </div>
      <div class="form-row"> 
       <dl>
